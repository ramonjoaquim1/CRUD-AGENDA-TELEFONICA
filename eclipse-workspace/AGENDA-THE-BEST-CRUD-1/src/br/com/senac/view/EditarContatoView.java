...
public class EditarContatoView extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(() -> {
            try {
                EditarContatoView frame = new EditarContatoView();
    ...
    public EditarContatoView() {
        ...
        ftfObservacao.setBounds(12, 366, 695, 171);
...
//            service.salvar(contatoVO);
    ...
    public void editar(ContatoVO cont) {
        ...
        this.ftfNumero.setText(cont.getNumero());
        this.ftfDdd.setText(cont.getDddnum());
        this.ftfEmails.setText(cont.getEmails());
//        this.ftfObservacao.setText(cont.getObserv());
    }
}
