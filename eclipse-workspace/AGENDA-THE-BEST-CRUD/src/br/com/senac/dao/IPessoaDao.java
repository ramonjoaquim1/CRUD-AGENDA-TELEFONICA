...
public interface IPessoaDao {
	...
	public abstract List<PessoaVO> listarPessoa(PessoaVO pessoaVO, 
											   BigInteger id, 
											   String descri, 
											   Date datnas,
											   String observ) throws BOException;
		
	public abstract void salvar(PessoaVO pessoaVO) 
			throws BOValidationException, BOException;
		
	public abstract void excluir(PessoaVO pessoaVO) 
			throws BOValidationException, BOException;
