...
public class Menu extends JFrame {
	...
	public Menu() {
		...
		JLabel lblBankingSystem = new JLabel("Sistema de Agenda");
...
//		contentPane.add(btnAddAccount);
		...
		JButton btnDepositToAccount = new JButton("");
		...
		JButton btnWithdrawFromAccount = new JButton("");
		...
		JButton btnDisplayAccountList = new JButton("");
		...
		lblNewLabel.setIcon(new ImageIcon(Menu.class.getResource("/img/imagem.png")));
		lblNewLabel.setBounds(477, 12, 135, 149);
