...
public class AdicionarPessoaView extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AdicionarPessoaView frame = new AdicionarPessoaView();
		...
		try {
			...
			try {
			    if (!datNasc.isEmpty()) {
			        ...
			        JOptionPane.showMessageDialog(this, "O campo 'Data de Nascimento' está vazio", "Erro",
			    ...
			    e.printStackTrace();
			    JOptionPane.showMessageDialog(this, "Formato de data inválido. (dd/MM/yyyy HH:mm:ss)", "Erro",
			            JOptionPane.ERROR_MESSAGE);
			    return;
			}
			...
			JOptionPane.showMessageDialog(null, "Sua edição foi realizada.");
